        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveTriggerCount = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RuntimeHeartbeats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxRunsPerMonth = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndpointSlug = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedRunsThisMonth = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentBlueprints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgentBlueprints_Agents_AgentId",
                        column: x => x.AgentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CronOrInterval = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentDeployments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgentDeployments_AgentVersions_AgentVersionId",
                        column: x => x.AgentVersionId,
                        principalTable: "AgentVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AgentDeployments_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AgentRuns_AgentVersions_AgentVersionId",
                        column: x => x.AgentVersionId,
                        principalTable: "AgentVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentBlueprints_AgentId",
                table: "AgentBlueprints",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentBlueprints_OrganizationId_AgentId_Status",
                table: "AgentBlueprints",
                columns: new[] { "OrganizationId", "AgentId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_AgentDeployments_AgentId",
                table: "AgentDeployments",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentDeployments_AgentVersionId",
                table: "AgentDeployments",
                column: "AgentVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentDeployments_OrganizationId_AgentId_Status",
                table: "AgentDeployments",
                columns: new[] { "OrganizationId", "AgentId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentRuns_AgentVersionId",
                table: "AgentRuns",
                column: "AgentVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_AgentRuns_OrganizationId_AgentId_CreatedAtUtc",
                table: "AgentRuns",
                columns: new[] { "OrganizationId", "AgentId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Agents_EndpointSlug",
                table: "Agents",
                column: "EndpointSlug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Agents_OrganizationId_Name",
                table: "Agents",
                columns: new[] { "OrganizationId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_AgentTools_OrganizationId_AgentId_Name",
                table: "AgentTools",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentTriggers_OrganizationId_AgentId_IsEnabled",
                table: "AgentTriggers",
                columns: new[] { "OrganizationId", "AgentId", "IsEnabled" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentVersions_OrganizationId_AgentId_VersionNumber",
                table: "AgentVersions",
                columns: new[] { "OrganizationId", "AgentId", "VersionNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsers_OrganizationId_Email",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationSubscriptions_OrganizationId_IsActive",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RuntimeHeartbeats_NodeName",
                table: "RuntimeHeartbeats",
                column: "NodeName",
                unique: true);
